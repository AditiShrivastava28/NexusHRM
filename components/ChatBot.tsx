...
import { IconBot, IconSend, IconXCircle, IconMinimize, IconMaximize, IconSparkles, IconCheckCircle, IconCalendar } from './Icons';
import { CURRENT_USER, SALARY_INFO, COMPANY_POLICIES, PAY_CYCLE_INFO } from '../constants';
  ...
  const initChat = () => {
    ...
    try {
      ...
      const systemContext = `
        ...
        Data: ${JSON.stringify(SALARY_INFO)}.
